...
const Home = () => {
    ...
    return (
        ...
        <Box mt={-100} pb={"5%"}>
                ...
                <Box>
                    {/*Start of Intro text*/}
                    <Flex justifyContent={"center"} alignItems={"center"} p={"5%"} h={"auto"} flexWrap={"wrap"}>
                            ...
                            <Card maxW='sm' boxShadow={"2xl"} variant='outline' m={"2%"}>
                                <CardBody>
                                    <Box h={"auto"} maxW={"400px"}>
                                        <Box >
                                            <Flex h={'120px'} justifyContent={"center"} p={"5%"}>
                                                <Icon as={FaNetworkWired} w={"100px"} h={"100%"} color={"red.500"} _groupHover={{color: "white"}} />
                                            </Flex>
                                        </Box>

                                        <Flex justifyContent={"center"} alignItems={"center"}  >
                                            <Text fontSize={["xl","2xl"]} fontWeight={"bold"} _groupHover={{color: "white"}}>IT Management</Text>
                                        </Flex>

                                        <Flex justifyContent={"center"} alignItems={"center"} p={"5%"}>
                                            <Text textAlign={"center"} color={"gray"} fontSize={"md"} _groupHover={{color: "white"}}>
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                    Consectetur doloremque eligendi est et exercitationem, facere, incidunt laboriosam</Text>
                                        </Flex>
                                        <Box>
                                            <Flex justifyContent={"center"} p={"5%"} >
                            ...
                            <Card maxW='sm' boxShadow={"2xl"} variant='outline' m={"2%"}>
                                <CardBody>
                                    <Box h={"auto"} maxW={"400px"}>
                                        <Box >
                                            <Flex h={'120px'} justifyContent={"center"} p={"5%"}>
                                                <Icon as={MdOutlineSecurity} w={"100px"} h={"100%"} color={"red.500"} _groupHover={{color: "white"}} />
                                            </Flex>
                                        </Box>

                                        <Flex justifyContent={"center"} alignItems={"center"}  >
                                            <Text fontSize={["xl","2xl"]} fontWeight={"bold"} _groupHover={{color: "white"}}>Cyber Security</Text>
                                        </Flex>

                                        <Flex justifyContent={"center"} alignItems={"center"} p={"5%"}>
                                            <Text textAlign={"center"} color={"gray"} fontSize={"md"} _groupHover={{color: "white"}}>
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                    Consectetur doloremque eligendi est et exercitationem, facere, incidunt laboriosam
                                                </Text>
                                        </Flex>
                                        <Box>
                                            <Flex justifyContent={"center"} p={"5%"} >
                            ...
                            <Card maxW='sm' boxShadow={"2xl"} variant='outline' m={"2%"}>
                                <CardBody>
                                    <Box h={"auto"} maxW={"400px"} >
                                        <Box >
                                            <Flex h={'120px'} justifyContent={"center"} p={"5%"}>
                                                <Icon as={AiOutlineCloudServer} w={"100px"} h={"100%"} color={"red.500"} fill={"red.500"} _groupHover={{color: "white"}} />
                                            </Flex>
                                        </Box>

                                        <Flex justifyContent={"center"} alignItems={"center"}  >
                                            <Text fontSize={["xl","2xl"]} fontWeight={"bold"} _groupHover={{color: "white"}}>Programming Lessons</Text>
                                        </Flex>
                            ...
                            <Card maxW='sm' boxShadow={"2xl"} variant='outline' m={"2%"}>
                                <CardBody>
                                    <Box h={"auto"} maxW={"400px"} >
                                        <Box >
                                            <Flex h={'120px'} justifyContent={"center"} p={"5%"}>
                                                <Icon as={AiOutlineFundProjectionScreen} w={"100px"} h={"100%"} color={"red.500"} fill={"red.500"} _groupHover={{color: "white"}} />
                                            </Flex>
                                        </Box>

                                        <Flex justifyContent={"center"} alignItems={"center"}  >
                                            <Text fontSize={["xl","2xl"]} fontWeight={"bold"} _groupHover={{color: "white"}}>Software Development</Text>
                                        </Flex>
            ...
            <Box p={"5%"}>
                ...
                <Flex>
                    {blogs.docs?.map((blog, index) => (
                        <Box m={"2px"} border={"1px solid"} borderColor={"red.200"} key={index}>
                            <Image
                            ...
                            />
                            <Box padding={"2%"}>
                                <Text fontSize={"20px"} p={"2% 0"} fontWeight={"bold"}>{blog.data().title}</Text>
                                <Text color={"gray"} mb={"2%"}>
                                    {blog.data().excerpt}
                                </Text>
                                <Link href={"#"} color={"red.500"}  p={"2% 0"} to={`news-and-blogs/${blog.id}`}>Read More >></Link>
                            </Box>
...
{/*
                    ...
                    <Box m={"2px"} border={"1px solid"} borderColor={"red.200"}>
                        ...
                        <Box padding={"2%"}>
                            ...
                            <Link href={"#"} color={"red.500"}  p={"2% 0"}>Read More >></Link>
                        </Box>
